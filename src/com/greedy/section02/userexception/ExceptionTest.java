...
public class ExceptionTest {
	...
	public void checkEnoughMoney(int price, int money) 
			throws  MoneyNegativeException, PriceNegativeException, NegativeException, NotEnoughtMoneyException {
		if(price < 0) {
		...
		if(money < price) {
			throw new NotEnoughtMoneyException("가진 돈 보다 상품 가격이 더 비쌉니다.");		
		}
